...
The Overfeat code in Python is available here: 

\href{https://github.com/sermanet/OverFeat/blob/master/API/python/sample.py}{$\txt{https://github.com/sermanet/OverFeat/blob/master/API/python/sample.py}$}. 
